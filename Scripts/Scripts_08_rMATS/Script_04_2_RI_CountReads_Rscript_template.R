...
file <- paste("SAMPLE_NAME", ".Aligned.sortedByCoord.out.bam", sep="")
file.index <- paste("SAMPLE_NAME", ".Aligned.sortedByCoord.out.bam.bai", sep="")
...
file <- paste("SAMPLE_NAME", ".txt", sep="")
